angular.module('acme').controller('votetoCtrl', function ($scope, $rootScope, apiService, ipCookie, $location, $http, userService, postSerivice, $translate) {
    ...
    $scope.checkvoteto = function () {
        ...
        var transaction = AcmeJS.vote.createVote(userService.secret, $rootScope.voteContent, $scope.secondpassword);
