angular.module('acme').controller('deletevoteCtrl', function ($scope, $rootScope, apiService, ipCookie, $location, $http, userService, postSerivice, $translate) {
    ...
    $scope.checkvoteto = function (params) {
        ...
        var transaction = AcmeJS.vote.createVote(userService.secret, $rootScope.deletevoteContent, $scope.secondpassword)
