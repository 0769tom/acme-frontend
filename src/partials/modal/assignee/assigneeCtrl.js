 ...
 */
angular.module('acme').controller('assigneeCtrl', function ($scope, $rootScope, apiService, ipCookie, $location, $http, userService, postSerivice, $translate) {
    ...
    $scope.nextstep = function () {
        ...
        var transaction = AcmeJS.delegate.createDelegate(userService.secret, $scope.userName, $scope.secondpassword)
