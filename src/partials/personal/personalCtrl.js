angular.module('acme').controller('personalCtrl', function ($scope, $rootScope, apiService, checkloginservice, ipCookie, $window, $http, userService, postSerivice, $translate) {
	...
	$scope.init = function (params) {
		apiService.account({
			address: AcmeJS.crypto.getAddress(userService.publicKey)
	...
	$scope.setPassWord = function () {
		...
		if (secondPwd != confirmPwd) {
			...
			var transaction = AcmeJS.signature.createSignature(userService.secret, $scope.secondpassword);
